...
class AppTest {
    ...
    void main() {
        ...
        // Continuez votre logique de test avec l'objet "game" créé
        grid.firstAdd(Direction.UP, new Tile(Color.RED, Shape.ROUND),new Tile(Color.RED, Shape.SQUARE));
        game.getCurrentPlayerScore();
        game.pass();
        grid.add(46,45,Direction.DOWN, new Tile(Color.RED, Shape.DIAMOND), new Tile(Color.RED, Shape.CROSS));
        System.out.println(game.getCurrentPlayerScore());
